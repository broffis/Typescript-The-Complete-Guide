...
var CollectionView = function () {
  ...
  CollectionView.prototype.render = function () {
    ...
    var templateElement = document.createElement('template'); // For some reason the array has a 0 length but contains 3 elements
...
var ApiSync = function () {
  function ApiSync(rooUrl) {
    this.rooUrl = rooUrl;
  }

  ApiSync.prototype.fetch = function (id) {
    return axios_1.default.get(this.rooUrl + "/" + id);
  };
  ...
  ApiSync.prototype.save = function (data) {
    ...
    if (id) {
      return axios_1.default.put(this.rooUrl + "/" + id, data);
    } else {
      return axios_1.default.post(this.rooUrl + "/", data);
    }
  };
...
exports.User = User;
},{"./Collection":"src/models/Collection.ts","./Model":"src/models/Model.ts","./Attributes":"src/models/Attributes.ts","./ApiSync":"src/models/ApiSync.ts","./Eventing":"src/models/Eventing.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
users.fetch();
},{"./views/UserList":"src/views/UserList.ts","./models/Collection":"src/models/Collection.ts","./models/User":"src/models/User.ts"}],"../../../.nvm/versions/node/v14.16.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
